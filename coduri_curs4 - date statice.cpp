...
public:
    ...
    static void f2(Test o){cout<<o.x<<" "<<o.y<<endl;} /// ok cu accesarea pt ca Test o este parametru formal, deci pe stiva lui f3
    static void f3(){Test o; cout<<o.x<<" "<<o.y<<endl;}
};

int main()
{
    Test::f1(); /// functiile membre statice au acces la datele const statice
    Test ob;
    Test::f2(ob);  /// functiile statice pot accesa dater locale/param locali, chiar daca acestea au in componenta date statice const sau nu
    Test::f3();
    return 0;
}
